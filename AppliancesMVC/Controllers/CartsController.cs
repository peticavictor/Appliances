...
namespace AppliancesMVC.Controllers
{
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreatedOn,IsPayed,UserId")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreatedOn,IsPayed,UserId")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
